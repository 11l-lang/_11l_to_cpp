    ...
    def to_str(self):
        ...
        if self.symbol.id == '(': # )
            if self.function_call:
                ...
                elif func_name in ('sum', 'all', 'any') and self.children[2].function_call and self.children[2].children[0].symbol.id == '.' and self.children[2].children[0].children[1].token_str() == 'map':
...
array_scope.add_name('index', ASTFunctionDefinition([('x', '', ''), ('start', '0', 'Int')]))
